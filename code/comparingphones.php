...
<nav id ="sidebar1" class="sidebar1">
		...
		<div class= "sidebar-header">
	<a href = 'dashboard.php' class = 'aaa'>	<h4 class = "h5" style = 'position:relative; left:100px;'>PhoneCompare</H4></a>
			</div>
...
<div class ="col-md-10 shadow-sm p-3 bg-light bb" style = "height:900px;" id = "chartscreen">
<h1 class="display-4">Compare Phones</h1>
<div id = "phonetable"></div>	
<div id = "phonetable1"></div>	
<div class = "form-group">
<form action="compare.php" method="post">
	<input type = "text" name = "search_text" id = "search_text" placeholder = "Search for phones!" class = 'form-control'><br>
	<input type = "text" name = "search_text1" id = "search_text1" placeholder = "Search for phones!" class = 'form-control'>
	<button type = "submit" class = "btn1">Compare</button>
	</form>
</div>
