<?php
	...
	$sql = "select phone_name, phone_price from phone where brandname = 'iPhone'";
...
<div class = "wrapper">
	...
	<nav id ="sidebar" class="sidebar">
		...
		<h4 class = "h5" id = 'h5'>PhoneCompare</H4>
			</div>
<div id = "links">
	 <a href="dashboardlogin.php" id = 'link'>Login</a>
  <a href="comparingphones.php"id = 'link'>Compare Devices</a>
   <a href="report.php" id = 'link'>Report</a>
	...
	<nav id ="sidebar1" class="sidebar1">
		...
		<div class= "sidebar-header">
		<h4 class = "h5" id = 'h5'style = 'position:relative; left:55px;'>PhoneCompare</H4>
			</div>
<div id = "mobilelinks" style = 'position:relative; left:105px; '>
	 <a href="dashboardlogin.php"style = 'color:black;' >Login</a><br>
...
<footer class="page-footer font-small stylish-color-dark pt-4 ">
 ...
 <hr>
    ...
    <p>
        ...
        <p>
          <i class="fas fa-phone mr-3"></i> 07940179707
        </p>
        <p>
...
laptop(x)//calls the function
x.addListener(laptop) //brings the listener function so it can run what the screen becomes the size
